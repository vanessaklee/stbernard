defmodule StbernardWeb.PropertyBased.LonestarSomewhatMoreComplexTest do
  @moduledoc """
  ...
  property "One field (amount) shall succeed with fuzzing" do
    Benchee.run(
      ...
      formatters: [
        ...
        {HTML, file: "benchee_output/lonestar/fuzzing_" <> DateTime.to_string(DateTime.utc_now) <> ".html", auto_open: true},
        {Markdown, file: "benchee_output/md/lonestar/fuzzing_" <> DateTime.to_string(DateTime.utc_now) <> ".md"}
      ]
    )
    HH.end_sess()
  end
